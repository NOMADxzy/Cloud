...
class Head extends React.Component {
    ...
    myexit = () => {
        ...
        // document.getElementById("circle_img").src='/public/avatar/default.jpeg';
        document.getElementById('input_box').style.display = 'block';
        this.setState({
            name: '未登录',
            head_img: '/public/avatar/default.jpeg'
    ...
    render() {
        return (
            <div className="head">
                ...
                <Link to={"/"}><p id={'exit'} style={{display: 'none'}}>1</p></Link>
                {/*<span className={'top_tab'}>*/}
                ...
                <span className={"dropdown"}>
                    <span id={'usernamespan'}>
                        ...
                        <a id={"username"}>{this.state.name}</a>
